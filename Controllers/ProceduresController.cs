...
namespace WalkthroughApp.Controllers
{
    public class ProceduresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Description,IsActive")] Procedure procedure)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Description,IsActive")] Procedure procedure)
        {
            if (id != procedure.Id)
            {
                return NotFound();
